...
public class MysqlControllerTest {
    ...
    @Test
    public void testgetMonthlyInventoryReportQueryingExistsReport() {
    ...
    @Test
    public void testLogUserInQueryingExistsUser() {
    ...
    // input: credentials (ArrayList of user doesn't exist)
    // expected result: null user
    @Test
    public void testLogUserInQueryingNOTExistsUser() {
        ArrayList<String> credentials = new ArrayList<>();
